 ...
 * in frontend/messages/*.json — flattened, because the panel needs a
...
const catalogues: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'sync.state.catching-up': 'Catching up…',
    'sync.state.offline': 'Offline',
    'sync.state.blocked': 'Needs attention',
    'sync.state.stale': 'Out of step',
    'sync.unsent': '{count} unsent',
    'sync.now': 'Sync now',
    ...
    'reminders.title': 'What should I remind you about?',
    'reminders.when': 'When',
    'reminders.addSubmit': 'Add reminder',
    'reminders.queued':
      'Saved. Reminders live on your phone — this one is on its way there.',
    'settings.title': 'Settings',
    'settings.gateway': 'Your Botvy address',
    'settings.gatewayHint':
      'Where this browser looks for your Botvy. Changing it signs nobody out.',
    'settings.save': 'Save',
    'capture.queued': 'Captured. It will be sent on the next pass.',
    'add.task': 'Task',
  ...
  ar: {
    ...
    'sync.state.catching-up': 'جارٍ اللحاق…',
    'sync.state.offline': 'غير متصل',
    'sync.state.blocked': 'يحتاج انتباهك',
    'sync.state.stale': 'غير محدَّث',
    'sync.unsent': '{count} لم تُرسل',
    ...
    'reminders.add': 'أضف تذكيرًا',
    'reminders.title': 'بمَ أذكّرك؟',
    'reminders.when': 'متى',
    'reminders.addSubmit': 'إضافة تذكير',
    'reminders.queued':
      'تم الحفظ. التذكيرات تعيش على هاتفك — وهذا في طريقه إليه.',
    'settings.title': 'الإعدادات',
    'settings.gateway': 'عنوان بوتفي الخاص بك',
    'settings.gatewayHint':
      'المكان الذي يبحث فيه هذا المتصفح عن بوتفي. تغييره لا يسجّل خروج أحد.',
    'settings.save': 'حفظ',
    'capture.queued': 'تم الالتقاط. سيُرسل في الجولة القادمة.',
    'add.task': 'مهمة',
    'add.reminder': 'تذكير',
    'add.meeting': 'اجتماع',
    'locale.label': 'اللغة',
